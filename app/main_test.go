...
func addProducts(count int) {
	...
	for i := 0; i < count; i++ {
		a.DB.Exec("INSERT INTO products(id, name, price) VALUES(:1, :2, :3)", nil, "Product "+strconv.Itoa(i), (i+1.0)*10)
	}
}
